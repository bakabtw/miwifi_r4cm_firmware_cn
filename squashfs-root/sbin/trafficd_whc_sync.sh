...
wifi_parse()
{
    ...
    [ "$txp_2" != "$txp_2_cur" -o "$ch_2" != "$ch_2_cur" -o "$bw_2" != "$bw_2_cur" ] && {
        son_changed=1
        WHC_LOGI " trafficd_whc_sync, wifi0 dev change $txp_2_cur:$ch_2_cur:$bw_2_cur -> $txp_2:$ch_2:$bw_2"
    ...
    [ "$txp_5" != "$txp_5_cur" -o "$ch_5" != "$ch_5_cur" -o "$bw_5" != "$bw_5_cur" ] && {
        son_changed=1
        WHC_LOGI " trafficd_whc_sync, wifi1 dev change $txp_5_cur:$ch_5_cur:$bw_5_cur -> $txp_5:$ch_5:$bw_5"
